...
export default class OtherBadges extends Component {
        ...
        return (
            <View style={{ marginTop: hp('1%'), marginRight: wp('3%'), height: hp('22%'), }}>
                <View style={{
                    ...
                    <View style={styles.imageView}>
                        <Image source={{ uri: serviceUrl.BadgesstreakImages + image.img }} resizeMode={'cover'} style={[styles.badgesOpened,{height:hp(15),backgroundColor:'green'}]} />
    ...
    render() {
        ...
        return (
            ...
            <View style={{ flex: 1, flexDirection: 'column', backgroundColor: '#fff',marginTop:0,marginBottom:'-3%' }}>
