...
import { View, Text, StyleSheet, StatusBar, Image, ScrollView, ImageBackground, ToastAndroid, TouchableOpacity, AsyncStorage } from 'react-native';
import { heightPercentageToDP as hp, widthPercentageToDP as wp } from 'react-native-responsive-screen';
import styles from './styles/placeProfileStyle'
import { Container, Title, Content, Button, Header, TabHeading, Badge, Left, Right, Body, Tabs, Tab } from 'native-base';
import serviceUrl from '../../Assets/Script/Service';
import GetMemoriesOtherUser from './GetMemoriesOtherUser';
import { TextInput, Menu, Divider } from 'react-native-paper';
import TaggedPostOtherUser from './TaggedPostOtherUser'
...
import businessProfileStyle from '../Busniess/styles/businessProfileStyle'
...
export default class BusinessPlacProfileOthers extends Component {
    ...
    locationFetch() {
        ...
        var data = {
            coords: this.state.linkedData[0].coords
        }
                ...
                <ScrollView>
                    ...
                    <View style={{ width: wp('100%'), flexDirection: 'row', justifyContent: 'space-around', }}>
                        ...
                        <View style={{ width: wp('11%'), justifyContent: 'center', }}>
                            <Image source={require(imagePath + 'Shape.png')} style={{ width: wp('10%'), height: hp('5%'), marginTop: wp('5%') }}>
                            </Image>
                            <Text style={{ textAlign: 'center' }}>{this.state.Consolidate_Like}</Text>
                        </View>
                        <View style={{ width: wp('11%'), justifyContent: 'center' }}>
                    ...
                    <View style={{ flex: 1, flexDirection: 'column', marginBottom: 10, justifyContent: 'flex-start', marginLeft: wp('5%') }}>
                        <Text style={{ fontSize: 18, fontWeight: "bold", fontFamily: Common_Color.fontBold }}>{this.state.originalName == undefined || this.state.originalName == null || this.state.originalName === "" ? "" : this.state.originalName}</Text>
                        <Text style={{ color: '#010101', fontSize: 14, fontFamily: Common_Color.fontMedium, textAlign: 'left', marginTop: 5, marginBottom: 5, }}>{this.state.bio == undefined || this.state.bio == null || this.state.bio == "" ? "" : this.state.bio}</Text>
                        <Text style={{ color: '#010101', fontSize: 14, fontFamily: Common_Color.fontMedium, textAlign: 'left', marginTop: 5, marginBottom: 5, }}>{this.state.website == undefined || this.state.website == null || this.state.website == "" ? "" : this.state.website}</Text>
                    </View>
                    ...
                    <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-evenly', marginBottom: 10 }}>
                        ...
                        <TouchableOpacity onPress={() => { this.gotoChat() }}>
                            <View style={{ backgroundColor: 'white', alignItems: 'center', justifyContent: 'center', borderRadius: 5, height: 30, width: wp('20%'), marginTop: wp('4%'), borderColor: '#448AFF', borderWidth: 1, }}>
                                <Text onPress={() => { this.gotoChat() }} style={{ color: '#448AFF', fontFamily: Common_Color.fontBold }}>Message</Text>
                            </View>
                        </TouchableOpacity>

                        {this.state.checkFollow === "Your request was not accepted" ?
                            <View style={{ borderWidth: 0.5, borderRadius: 5, alignItems: 'center', justifyContent: 'center', height: 30, width: wp('30%'), marginTop: wp('4%'), backgroundColor: '#fb0042', }}>
                        ...
                        {this.state.checkFollow === "You follow this user" ?
                            <View style={{ borderWidth: 0.5, borderRadius: 5, alignItems: 'center', justifyContent: 'center', height: 30, width: wp('30%'), marginTop: wp('4%'), backgroundColor: '#fb0042', }}>
                                <TouchableOpacity onPress={() => this.unfollowAcc()} style={[businessProfileStyle.createButton, { marginTop: wp('1.8%') }]}>
                                    <Text style={{ textAlign: 'center', marginBottom: 'auto', color: '#fff' }} >Following</Text>
                                </TouchableOpacity>
                            </View>
                            : null}
